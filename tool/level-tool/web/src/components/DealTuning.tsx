      ...
      */}
      ...
      >
        ...
        <p className="hint">
          ...
          по убыванию: <span className="mono">4-4-4-3-3-2</span> — три категории
          целиком, две по тройке, одна парой. Уровень с минимумом категорий
          ...
          раздача: минимум три готовые четвёрки (столько ходов игрок видит
          глазами, не угадывая), остальным минимум пара, без одиночек.
        </p>

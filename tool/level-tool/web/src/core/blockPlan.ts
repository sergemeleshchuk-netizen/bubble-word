...
export const DEFAULT_BLOCK_CONFIG: BlockConfig = {
   ...
   * калибровки по декадам. Замер всех 199 уровней оригинала показал, что глубже
   * двух мета-цепь не встречается ни разу, и калиброванный путь
   * (`configForRange`) с тех пор ставит 2. Пресет 201-210 остался на трёх, и это

...
| файл | что это |
|---|---|
| `база-слов.sqlite` | **сама база**, файл SQLite (7.1 МБ). Открывается любым просмотрщиком SQLite, например DB Browser for SQLite |
| `ревью/` | материалы для проверки базы человеком или внешней моделью |

## Что внутри базы

- категорий: **1092** в 58 темах
- уникальных слов: **10005**
- связей слово-категория: **17550**
- значений у многозначных слов: **549** (у 222 слов)
- слов в двух и более категориях: **3456** (35%)
